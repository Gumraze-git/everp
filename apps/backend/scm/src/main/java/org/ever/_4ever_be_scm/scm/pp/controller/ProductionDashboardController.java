...
@Slf4j
@RestController
@RequestMapping("/scm-pp/pp/workflow-items")
...
public class ProductionDashboardController {
    ...
    public ResponseEntity<List<DashboardWorkflowItemDto>> getQuotationsToProduction(
     ...
     */
    @GetMapping("/mes")
    public ResponseEntity<List<DashboardWorkflowItemDto>> getProductionInProgress(
            @RequestParam("userId") String userId,
            @RequestParam(value = "size", defaultValue = "5") int size
    ) {

...
public final class ProblemDetailFactory {
    ...
    public static ProblemDetail notFound(String detail, Object errors, HttpServletRequest request, Integer code) {
        return createWithErrors(HttpStatus.NOT_FOUND, "요청한 리소스를 찾을 수 없습니다.", detail, errors, request, code);
    }

    public static ProblemDetail serverError(String detail, HttpServletRequest request, Integer code) {
        return create(

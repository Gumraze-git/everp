package org.ever._4ever_be_alarm.common.saga;
...
import org.ever._4ever_be_alarm.common.audit.EntityChange;
import org.ever._4ever_be_alarm.common.audit.TransactionChanges;
import org.ever._4ever_be_alarm.common.repository.TransactionChangeLogRepository;
    ...
    public void compensate(String transactionId) {
        ...
        changeLogRepository.findByTransactionId(transactionId).ifPresent(logEntry -> {
            try {
                ...
                log.error("Error during compensation of transaction {}: {}", transactionId,
                    e.getMessage(), e);
                throw new RuntimeException("Compensation failed for transaction: " + transactionId,
                    e);
            }
        });
    }
        ...
        switch (change.getChangeType()) {
            ...
            case "UPDATED":
                if (change.getPreviousState() != null) {
                    Object previousState = objectMapper.convertValue(change.getPreviousState(),
                        entityType);
            ...
            case "DELETED":
                if (change.getPreviousState() != null) {
                    Object deletedEntity = objectMapper.convertValue(change.getPreviousState(),
                        entityType);

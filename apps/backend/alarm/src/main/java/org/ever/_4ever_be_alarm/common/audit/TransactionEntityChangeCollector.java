package org.ever._4ever_be_alarm.common.audit;
...
import org.ever._4ever_be_alarm.common.entity.TransactionChangeLog;
import org.ever._4ever_be_alarm.common.repository.TransactionChangeLogRepository;
import org.ever._4ever_be_alarm.common.saga.SagaTransactionContext;
...
public class TransactionEntityChangeCollector {
    ...
    public void recordChange(String entityType, String entityId, ChangeType changeType,
        ...
        if (transactionId == null) {
            log.warn("No active saga transaction found for entity change: {} - {}", entityType,
                entityId);
            return;
        }
        ...
        changesByTransaction.computeIfAbsent(transactionId, k -> new TransactionChanges())
            .addChange(change);
    ...
    public void persistChanges(String transactionId) {
        ...
        if (changes != null && !changes.getChanges().isEmpty()) {
            try {
                ...
                changeLog.assignTransactionId(transactionId);

...
public final class ProblemDetailFactory {
    ...
    public static ProblemDetail fromLegacyResponse(
        int status,
        String message,
        Object errors,
        HttpServletRequest request
        ...
        return createWithErrors(httpStatus, message, message, errors, request, extractCode(errors));
    }
    ...
    private static Integer extractCode(Object errors) {

...
export const PRODUCTION_ENDPOINTS = {
  ...
  MRP_CONVERT: `${PRODUCTION_BASE_PATH}/mrp-runs`, // MRP 순소요 목록 조회
  ...
  QUOTATION_PREVIEW: `${PRODUCTION_BASE_PATH}/quotations/mps-previews`, // 제안납기 확정 프리뷰
  QUOTATION_SIMULATE: `${PRODUCTION_BASE_PATH}/quotations/simulations/search`, // 견적에 대한 ATP + MPS + MRP 시뮬레이션 실행
  QUOTATION_CONFIRM: `${PRODUCTION_BASE_PATH}/quotations/reviews`, // 제안 납기 확정

  // PP 통계
  STATISTICS: `${PRODUCTION_BASE_PATH}/metrics`, // PP 통계 조회

  // 드롭다운 관련
  MPS_TOGGLE_PRODUCTS: `${PRODUCTION_BASE_PATH}/quotations/bom-options`,
  OPERATIONS_DROPDOWN: `${PRODUCTION_BASE_PATH}/operations`,

  PRODUCTS: `${PRODUCTION_BASE_PATH}/products`, // 자재 드롭다운
  AVAILABLE_STATUS_DROPDOWN: `${PRODUCTION_BASE_PATH}/quotations/available-status-options`, // 가용재고 상태 드롭다운
  QUOTATION_STATUS_DROPDOWN: `${PRODUCTION_BASE_PATH}/quotations/status-options`, // 견적 상태 드롭다운

  MRP_QUOTATION_DROPDOWN: `${PRODUCTION_BASE_PATH}/quotations/mrp/quotation-options`, // 견적 드롭다운
  MRP_AVAILABLE_STATUS_DROPDOWN: `${PRODUCTION_BASE_PATH}/quotations/mrp/available-status-options`, // 견적 드롭다운

  MRP_RUNS_QUOTATIONS_DROPDOWN: `${PRODUCTION_BASE_PATH}/mrp-runs/quotation-options`, // MRP 계획주문 견적 드롭다운
  MRP_RUNS_STATUS_DROPDOWN: `${PRODUCTION_BASE_PATH}/mrp-runs/status-options`, // MRP 계획주문 상태 드롭다운
  MES_STATUS_DROPDOWN: `${PRODUCTION_BASE_PATH}/mes/status-options`, // MES 상태 드롭다운
};
